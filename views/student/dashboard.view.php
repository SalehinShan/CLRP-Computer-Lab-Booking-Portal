<?php
// views/student/dashboard.view.php - Student Dashboard View Template
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #d97706;"><?= $total_pending ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #dc2626;"><?= $total_issues ?></div>
                                                ...
                                                <form action="<?= url('/student/dashboard.php') ?>" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" name="reservation_date" class="form-control" min="<?= date('Y-m-d') ?>" value="<?= date('Y-m-d') ?>" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Time Slot</label>
                                                            <select name="time_slot" class="form-select" required>
                                                                <option value="08:00 - 09:30">08:00 AM - 09:30 AM</option>
                                                                <option value="09:40 - 11:10">09:40 AM - 11:10 AM</option>
                                                                <option value="11:20 - 12:50">11:20 AM - 12:50 PM</option>
                                                                <option value="01:00 - 02:30">01:00 PM - 02:30 PM</option>
                                                                <option value="02:40 - 04:10">02:40 PM - 04:10 PM</option>
                                                            </select>
                                                        </div>
                                                    </div>
