    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #60a5fa;"><?= $assigned_tickets ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #fbbf24;"><?= $pending_work ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #34d399;"><?= $resolved_tickets ?></div>
