...
<main class="app-content">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-2-4 col-sm-6 col-12">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #34d399;"><?= $avail_pcs ?></div>
        ...
        <div class="col-md-2-4 col-sm-6 col-12">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #f87171;"><?= $maint_pcs ?></div>
        ...
        <div class="col-md-2-4 col-sm-6 col-12">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #60a5fa;"><?= $active_bookings ?></div>
    ...
    <?php elseif ($tab === 'labs'): ?>
        ...
        <!-- Render Edit Lab modals outside the table to avoid invalid nesting -->
        <?php foreach ($labs as $lab): ?>
    ...
    <?php elseif ($tab === 'computers'): ?>
        ...
        <!-- Render Edit PC modals outside the table to avoid invalid nesting -->
        <?php foreach ($computers as $pc): ?>
    ...
    <?php elseif ($tab === 'users'): ?>
        ...
        <div class="content-card">
            ...
            <div class="table-custom-container table-scrollable mb-4">
                <table class="table-custom">
                    <thead>
                        <tr>
                            <th>Student ID</th>
